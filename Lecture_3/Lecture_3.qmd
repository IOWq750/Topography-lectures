...
![](Lecture_3_files/pics/Sedlo2.jpg){style="height:45vh; object-fit:contain;"}
...
```{=html}
<div style="display:flex; flex-direction:column; align-items:center; gap:1.2rem; margin-top:0.5rem;">
  <img src="Lecture_3_files/pics/Sedlo1.jpg"
       style="height:50vh; width:auto; object-fit:contain; display:block;">
</div>
```
...
![](Lecture_3_files/pics/Survey.jpg){style="height:25vh; object-fit:contain;"}

:::

::: {.column width="50%}

![](Lecture_3_files/pics/Survey2.jpg){style="height:25vh; object-fit:contain;"}
